                ...
                try:
                    ...
                    if sections:
                        peer_ratios_block = (
                            ...
                            "**VERBATIM CITATION DISCIPLINE (Phase 8.2):** "
                            "for every peer ratio you cite, copy the cell "
                            "value to **2 decimal places exactly** as it "
                            "appears in the table. Examples:\n"
                            "  ✓ Table says `MSFT.forward_pe = 21.59` "
                            "→ write `MSFT Forward P/E 21.59x` (verbatim)\n"
                            "  ✗ Do NOT round to `21.6x` or `~22x`\n"
                            "  ✗ Do NOT recompute from `price ÷ EPS` to "
                            "get `21.67x` (your computed value may match "
                            "within 5% tolerance but it is not the cell)\n"
                            "  ✗ Do NOT carry forward a prior-decision "
                            "value (e.g. `27.51x` from 2026-05-08) when "
                            "the current cell reads `21.59x`\n"
                            "The pipeline computes these cells in Python "
                            "specifically so you can READ THEM rather than "
                            "DERIVE them. A 0.01 deviation from the cell "
                            "value is a discipline failure even when within "
                            "validator tolerance — the goal is verbatim, "
                            "not 'close enough'.\n\n"
